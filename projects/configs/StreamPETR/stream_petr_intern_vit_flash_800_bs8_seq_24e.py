_base_ = [
    '../../../mmdetection3d/configs/_base_/datasets/nus-3dbk.py',
...
model = dict(
    ...
    img_backbone=dict(
        type='InternViT',
        model_name_or_path='ckpts/InternViT-300M-448px-V2_5',
        pretrained=True,
    ...
    pts_bbox_head=dict(
        ...
        in_channels=256,
        num_query=644,
        # num_query=1500, # * Scale this to 1500 for 28e
        memory_len=1024,
        topk_proposals=256,
        num_propagated=256,
        with_ego_pos=True,
        ...
        transformer=dict(
            ...
            decoder=dict(
                ...
                num_layers=6, # Scale this to 12 for 28e
...
data = dict(
    ...
    # test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, ann_file=data_root + 'nuscenes_infos_test.pkl', classes=class_names, modality=input_modality),
